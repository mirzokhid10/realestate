                                ...
                                <tbody>
                                    @foreach ($property as $key => $item)
                                        <tr>
                                            ...
                                            <td class="text-start align-middle"><img src="{{ asset($item->property_thambnail) }}"
                                                    style="width:70px; height:40px;"> </td>
                                            <td class="text-start align-middle">{{ $item->property_name }}</td>
                                            <td class="text-start align-middle">{{ $item['type']['type_name'] }}</td>
                                            <td class="text-start align-middle">{{ $item->property_status }}</td>
                                            <td class="text-start align-middle">{{ $item->city }}</td>
                                            <td class="text-start align-middle">{{ $item->property_code }}</td>
