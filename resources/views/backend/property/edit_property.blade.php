...
@section('admin')
    ...
    <div class="page-content">
        <div class="row profile-body">
            ...
            <div class="page-content px-2" style="margin-top: -10px;">
                <div class="row profile-body px-1">
                    <div class="col-md-12 col-xl-12 middle-wrapper">
                        <div class="row">
                            <div class="card">
                                <div class="card-body">
            ...
            <div class="page-content px-2" style="margin-top: -35px;">
                <div class="row profile-body px-1">
                    <div class="col-md-12 col-xl-12 middle-wrapper">
                        <div class="row">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="post" action="{{ route('update.property.multiimage') }}"
                                        id="myForm" enctype="multipart/form-data">
                                        @csrf
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    @foreach ($multiImage as $key => $img)
                                                        <tr>
                                                            <td class="col align-self-center">{{ $key + 1 }}</td>
                                                            <td class="py-1">
